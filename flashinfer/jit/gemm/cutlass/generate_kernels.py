...
class TrtLlm_GemmLauncher:
    ...
    def __repr__(self):
        ...
        hopper_suffix = "_{}x{}x{}{}{}{}{}{}".format(
            ...
            "_swap_ab"
            if self.swap_ab
            else "",  # TODO (yongwww): probably time to copy the whole files from trtllm
        )
...
"""
        ...
        INSTANTIATE_TMA_WARP_SPECIALIZED_MOE_GEMM({arch_tag}, {act_tag}, {weight_tag}, {out_tag},
                {epi_tag}, {epi_fusion}, {operation.cta_shape[0]}, {operation.cta_shape[1]}, {operation.cta_shape[2]}, {operation.cga_shape[0]}, {operation.cga_shape[1]}, {operation.cga_shape[2]}, {"true" if operation.is_mx_fpx else "false"}, false, {"true" if operation.swap_ab else "false"});\n
#endif
"""
